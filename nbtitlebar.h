...
class NBTitlebarPrivate;
class NBTitlebar : public QFrame, public DTK_CORE_NAMESPACE::DObject
{
    Q_OBJECT
public:
    explicit NBTitlebar(QWidget *parent = Q_NULLPTR);
...
class NTitleBar : public Dtk::Widget::NBTitlebar {};
